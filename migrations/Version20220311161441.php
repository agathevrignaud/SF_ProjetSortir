 ...
 */
final class Version20220311161441 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD motif_annulation VARCHAR(100) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie DROP motif_annulation, CHANGE nom nom VARCHAR(100) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE info_sortie info_sortie LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
